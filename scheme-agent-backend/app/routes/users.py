...
async def create_user(
    ...
    new_user = User(
        ...
        auth_id=str(uuid.uuid4()),  # generated by the backend — frontend never needs to send this
    ...
    from app.tasks import run_scheme_matching, run_document_extraction
    run_scheme_matching.delay(new_user.aadhaar_number)
    run_document_extraction.delay(new_user.aadhaar_number, "aadhaar", aadhaar_doc_url)
